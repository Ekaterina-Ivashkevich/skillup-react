...
import "../DialogDelete/DialogDelete.scss";
    ...
    return (
        <Dialog open={isDialogDeleteOpened} className="dialog-delete" onClose={close}>
            <div className="dialog-delete__box">
                <IconButton size="small" onClick={close}> <Close /></IconButton>
          Are you sure you want to delete TODO?
            <div className="dialog-delete__actions">
                <Button color="primary" variant="outlined" onClick={close}>No</Button>
                <Button color="secondary" variant="contained" onClick={deleteFunction}>Delete</Button>
            </div>
            </div>
        </Dialog>
    );
